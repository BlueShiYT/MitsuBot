let handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    switch (type) {
                ...
                if (global.DATABASE._data.users[m.sender].makananpet > 0) {
                    ...
                    if (rubah > 0) {
                        ...
                        if (global.DATABASE._data.users[m.sender].anakrubah > naiklvl) {
                            ...
                            global.DATABASE._data.users[m.sender].anakrubah -= (rubah * 1000)
                ...
                if (global.DATABASE._data.users[m.sender].makananpet > 0) {
                    ...
                    if (kuda > 0) {
                        ...
                        if (global.DATABASE._data.users[m.sender].anakkuda > naiklvl) {
                            ...
                            global.DATABASE._data.users[m.sender].anakkuda -= (kuda * 1000)
        ...
        case 'serigala':
            ...
            let __waktus = (new Date - global.DATABASE._data.users[m.sender].serigalalastclaim)
            let _waktus = (600000 - __waktus)
            let waktus = clockString(_waktus)
            if (new Date - global.DATABASE._data.users[m.sender].serigalalastclaim > 600000) {
                if (global.DATABASE._data.users[m.sender].makananpet > 0) {
                    global.DATABASE._data.users[m.sender].makananpet -= 1
                    global.DATABASE._data.users[m.sender].anakserigala += 20
                    global.DATABASE._data.users[m.sender].serigalalastclaim = new Date * 1
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                    ...
                    if (serigala > 0) {
                        ...
                        if (global.DATABASE._data.users[m.sender].anakserigala > naiklvl) {
                            global.DATABASE._data.users[m.sender].serigala += 1
                            global.DATABASE._data.users[m.sender].anakserigala -= (serigala * 10000)
        ...
        case 'naga':
            ...
            let __waktug = (new Date - global.DATABASE._data.users[m.sender].nagalastclaim)
            ...
            if (new Date - global.DATABASE._data.users[m.sender].nagalastclaim > 600000) {
                if (global.DATABASE._data.users[m.sender].makanannaga > 0) {
                    global.DATABASE._data.users[m.sender].makanannaga -= 1
                    global.DATABASE._data.users[m.sender].anaknaga += 20
                    global.DATABASE._data.users[m.sender].nagalastclaim = new Date * 1
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                    ...
                    if (naga > 0) {
                        ...
                        if (global.DATABASE._data.users[m.sender].anaknaga > naiklvl) {
                            ...
                            global.DATABASE._data.users[m.sender].anaknaga -= (naga * 10000)
      ...
      case 'kyubi':
            ...
            let __waktuyu = (new Date - global.DATABASE._data.users[m.sender].kyubilastclaim)
            let _waktuyu = (600000 - __waktuyu)
            let waktuyu = clockString(_waktuyu)
            if (new Date - global.DATABASE._data.users[m.sender].kyubilastclaim > 600000) {
                if (global.DATABASE._data.users[m.sender].makanankyubi > 0) {
                    global.DATABASE._data.users[m.sender].makanankyubi -= 1
                    global.DATABASE._data.users[m.sender].anakkyubi += 20
                    global.DATABASE._data.users[m.sender].kyubilastclaim = new Date * 1
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                    ...
                    if (kyubi > 0) {
                        ...
                        if (global.DATABASE._data.users[m.sender].anakkyubi > naiklvl) {
                            global.DATABASE._data.users[m.sender].kyubi += 1
                            global.DATABASE._data.users[m.sender].anakkyubi -= (kyubi * 10000)
      ...
      case 'centaur':
            ...
            let __waktuur = (new Date - global.DATABASE._data.users[m.sender].centaurlastclaim)
            let _waktuur = (600000 - __waktuur)
            let waktuur = clockString(_waktuur)
            if (new Date - global.DATABASE._data.users[m.sender].centaurlastclaim > 600000) {
                if (global.DATABASE._data.users[m.sender].makanancentaur > 0) {
                    global.DATABASE._data.users[m.sender].makanancentaur -= 1
                    global.DATABASE._data.users[m.sender].anakcentaur += 20
                    global.DATABASE._data.users[m.sender].centaurlastclaim = new Date * 1
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                    ...
                    if (centaur > 0) {
                        ...
                        if (global.DATABASE._data.users[m.sender].anakcentaur > naiklvl) {
                            global.DATABASE._data.users[m.sender].centaur += 1
                            global.DATABASE._data.users[m.sender].anakcentaur -= (centaur * 10000)
         ...
         case 'phonix':
            ...
            let __waktux = (new Date - global.DATABASE._data.users[m.sender].phonixlastclaim)
            let _waktux = (600000 - __waktux)
            let waktux = clockString(_waktux)
            if (new Date - global.DATABASE._data.users[m.sender].phonixlastclaim > 600000) {
                if (global.DATABASE._data.users[m.sender].makananphonix > 0) {
                    global.DATABASE._data.users[m.sender].makananphonix -= 1
                    global.DATABASE._data.users[m.sender].anakphonix += 20
                    global.DATABASE._data.users[m.sender].phonixlastclaim = new Date * 1
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                    ...
                    if (phonix > 0) {
                        ...
                        if (global.DATABASE._data.users[m.sender].anakphonix > naiklvl) {
                            global.DATABASE._data.users[m.sender].phonix += 1
                            global.DATABASE._data.users[m.sender].anakphonix -= (phonix * 10000)
        ...
        case 'griffin':
            ...
            let __waktufin = (new Date - global.DATABASE._data.users[m.sender].griffinastclaim)
            let _waktufin = (600000 - __waktufin)
            let waktufin = clockString(_waktufin)
            if (new Date - global.DATABASE._data.users[m.sender].griffinlastclaim > 600000) {
                if (global.DATABASE._data.users[m.sender].makanangriffin > 0) {
                    global.DATABASE._data.users[m.sender].makanangriffin -= 1
                    global.DATABASE._data.users[m.sender].anakgriffin += 20
                    global.DATABASE._data.users[m.sender].griffinlastclaim = new Date * 1
                    conn.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    setTimeout(() => {
                    ...
                    if (griffin > 0) {
                        ...
                        if (global.DATABASE._data.users[m.sender].anakgriffin > naiklvl) {
                            global.DATABASE._data.users[m.sender].griffin += 1
                            global.DATABASE._data.users[m.sender].anakgriffin -= (griffin * 10000)
                ...
                if (global.DATABASE._data.users[m.sender].makananpet > 0) {
                    ...
                    if (kucing > 0) { 
                        ...
                        if (global.DATABASE._data.users[m.sender].anakkucing > naiklvl) {
                            ...
                            global.DATABASE._data.users[m.sender].anakkucing -= (kucing * 1000)
